...
public class HogwartsTestTaskController {
    ...
    public ResultDto updateTaskStatus(HttpServletRequest request
            , @RequestBody UpdateHogwartsTestTaskStatusDto updateHogwartsTestTaskStatusDto) throws IOException, URISyntaxException {


        return hogwartsTestTaskService.updateStatus(new HogwartsTestTask());
