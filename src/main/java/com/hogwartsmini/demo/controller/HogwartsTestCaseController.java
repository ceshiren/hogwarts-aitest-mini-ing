...
import com.hogwartsmini.demo.dto.AddHogwartsTestCaseDto;
import com.hogwartsmini.demo.dto.QueryHogwartsTestCaseListDto;
import com.hogwartsmini.demo.dto.RunCaseDto;
import com.hogwartsmini.demo.dto.UpdateHogwartsTestCaseDto;
...
public class HogwartsTestCaseController {
    ...
    @GetMapping("/{caseId}")
    public ResultDto<HogwartsTestCase> getById(HttpServletRequest request
    ...
    public ResultDto<PageTableResponse<HogwartsTestCase>> list(HttpServletRequest request
        ...
        ResultDto<PageTableResponse<HogwartsTestCase>> responseResultDto = hogwartsTestCaseService
                .list(pageTableRequest);
    ...
    @PostMapping("run")
    public ResultDto getCaseDataById(HttpServletRequest request
            ,@RequestBody RunCaseDto runCaseDto) throws Exception {
